 ...
 * 官方文档（核对日期 2026-09-13，来源见 docs/MODEL_SPECS.md）。认不出来的模型一律
...
const EFFORT_RULES = [
  ...
  { match: ['kimi-k2.7-code', 'kimi-k2.6'], noEffort: '只有 thinking 开关，官方不支持 reasoning_effort' },
...
const VISION_FAMILIES = [
  ...
  // Kimi Code 的四个 Model ID 都支持图片输入（其中 k3-256k 仅图片，其余还支持视频）。
